    ...
    <!-- <div class="row" style="background: #white;"> -->
      ...
      <!-- <div class="col-md-12 align-center asu-global--inner">
        <div class="asu-os-logo-plus-asu">
          <img src="sites/all/themes/asu_scholar/images/logo-openscholar-plus-asu.png"/>
        </div>
          ...
          <div class="col-md-6 col-sm-12 sellingpoints">
            <div class="row">
              <div class="col-md-3 col-sm-3 col-xs-3">
                <img src="sites/all/themes/asu_scholar/images/icon-brackets-maroon-lg.png" />
              </div>
            ...
            <div class="row">
              <div class="col-md-3 col-sm-3 col-xs-3">
                <img src="sites/all/themes/asu_scholar/images/icon-key-maroon-lg.png" />
              </div>
              <div class="col-md-9 col-sm-9 col-xs-9">
                <div class="talkingpoint">
            ...
            <div class="row">
              <div class="col-md-3 col-sm-3 col-xs-3">
                <img src="sites/all/themes/asu_scholar/images/icon-tools-maroon-lg.png" />
              </div>
              <div class="col-md-9 col-sm-9 col-xs-9">
                <div class="talkingpoint">
        ...
        <div class="col-md-6 col-sm-12">
          <div>
            <div style="position: absolute;">
              <img src="sites/all/themes/asu_scholar/images/img-profile-demo.png">
            </div>
          </div>
        </div>
